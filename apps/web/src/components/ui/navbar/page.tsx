  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-sm font-bold md:gap-10">
        <Button className="text-white transition-all bg-black border-black hover:text-black hover:bg-white border-[1px]">
          Talk<div className="hidden md:flex ml-[-4px]">with me</div>
        </Button>
        <Button className="text-black transition-all bg-white border-black hover:text-white hover:bg-black border-[1px]">
          See my work
        </Button>
      </div>
    </div>
